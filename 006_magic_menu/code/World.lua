...
function World:DrawKey(menu, renderer, x, y, item)
    ...
    if item then
        ...
        font:DrawText2d(renderer, x, y, itemDef.name)
    else
        font:AlignText("center", "center")
        font:DrawText2d(renderer, x + menu.mSpacingX/2, y, " - ")
    end
end
...
function World:DrawItem(menu, renderer, x, y, item, color)
    ...
    if item then
        ...
        font:AlignText("left", "center")
        font:DrawText2d(renderer, x + 18, y, itemDef.name, color)
        ...
        font:AlignText("center", "center")
        font:DrawText2d(renderer, x + menu.mSpacingX/2, y, " - ", color)
    end
end