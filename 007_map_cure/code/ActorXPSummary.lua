...
function ActorXPSummary:Render(renderer)
    ...
    font:DrawText2d(renderer, nameX, nameY, self.mActor.mName)

    -- Level
    local strLevelLabel = "Level:"
    local strLevelValue = string.format("%d", self.mActor.mLevel)
    local levelY = nameY - 42
    font:DrawText2d(renderer, nameX, levelY, strLevelLabel)
    statFont:AlignText("left", "top")
    statFont:DrawText2d(renderer, nameX + 12, levelY, strLevelValue)
    ...
    font:DrawText2d(renderer, rightLabel, nameY, strXPLabel)
    statFont:AlignText("right", "top")
    statFont:DrawText2d(renderer, right, nameY, strXPValue)
    ...
    font:DrawText2d(renderer, rightLabel, levelY, strNextLevelLabel)
    statFont:DrawText2d(renderer, right, levelY, strNextLevelValue)
